...
const DrawerList = [
    ...
    },
    {
        ...
        navigateTo: 'viewAppointment',
        icon: 'right',
        mainRoute: 'root',
    },
    {
        label: 'Report an Absence',
        navigateTo: 'leaveApplication',
        icon: 'right',
        mainRoute: 'root',
    },
    ...
    {
        label: 'Compensation',
        navigateTo: 'compensation',
        icon: 'right',
        mainRoute: 'root',
    },
    {
        label: 'Testimonials',
        navigateTo: 'addTestimonial',
        icon: 'right',
        mainRoute: 'root',
    },
    {
...
function CustomDrawerContent(props) {
    ...
    const src = user?.picture
        ...
        : require('../../images/profileAvatar.png'); // Profile image source
