...
export const screenDimensions = Dimensions.get('window') // its give mobile width, height, font and scale // e.x: screenDimension.width
...
//i its function to remove errors of input fileds
